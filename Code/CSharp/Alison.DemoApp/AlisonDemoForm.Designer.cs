namespace Alison.Demo
{
	partial class AlisonDemoForm
	{
		...
		{
			this._msAlison = new MenuStrip();
			this.toolsToolStripMenuItem = new ToolStripMenuItem();
			this.settingsToolStripMenuItem = new ToolStripMenuItem();
			this._tsAlison = new ToolStrip();
			this._zsAlison = new StatusStrip();
			this._tcAlisonDemo = new TabControl();
			...
			// _msAlison
			// 
			this._msAlison.Font = new Font("Consolas", 10F);
			this._msAlison.Items.AddRange(new ToolStripItem[] { this.toolsToolStripMenuItem });
			this._msAlison.Location = new Point(0, 0);
			this._msAlison.Name = "_msAlison";
			this._msAlison.Size = new Size(1058, 25);
			...
			// _tsAlison
			// 
			this._tsAlison.Location = new Point(0, 25);
			this._tsAlison.Name = "_tsAlison";
			this._tsAlison.Size = new Size(1058, 25);
			this._tsAlison.TabIndex = 1;
			this._tsAlison.Text = "toolStrip1";
			// 
			// _zsAlison
			// 
			this._zsAlison.Font = new Font("Consolas", 10F);
			this._zsAlison.Location = new Point(0, 645);
			this._zsAlison.Name = "_zsAlison";
			this._zsAlison.Size = new Size(1058, 22);
			...
			this._tcAlisonDemo.Dock = DockStyle.Fill;
			this._tcAlisonDemo.Location = new Point(0, 50);
			this._tcAlisonDemo.Name = "_tcAlisonDemo";
			this._tcAlisonDemo.SelectedIndex = 0;
			this._tcAlisonDemo.Size = new Size(1058, 595);
