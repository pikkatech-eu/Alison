...
{
	public partial class AgadirDemoForm : Form
	{
		...
		private AgadirDemoSettings _settings = new AgadirDemoSettings();

		public AgadirDemoForm()
		{
			InitializeComponent();
			...
			try
			{
				this._settings = AgadirDemoSettings.Load(SETTINGS_FILE_NAME);
		...
		{
			AgadirDemoSettingsDialog dialog = new AgadirDemoSettingsDialog();
