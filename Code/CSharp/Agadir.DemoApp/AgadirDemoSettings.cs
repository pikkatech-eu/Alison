/***********************************************************************************
* File:         AgadirDemoSettings.cs                                              *
* Contents:     Class AgadirDemoSettings                                           *
...
using Agadir.Library.Enumerations;
using Factotum.Xml;

namespace Agadir.Demo
{
	public class AgadirDemoSettings
	{
		...
		{
			XElement x = new XElement("AgadirDemoSettings");
		...
		public static AgadirDemoSettings FromXElement(XElement x)
		{
			...
			AgadirDemoSettings settings = new AgadirDemoSettings();
			if (xSoundex != null)
			{
		...
		public static AgadirDemoSettings Load(string fileName)
		{
