/***********************************************************************************
* File:         DoubleMetaphonePhonix.cs                                           *
* Contents:     Class DoubleMetaphonePhonix                                        *
* Author:       Stanislav "Bav" Koncebovski (stanislav@pikkatech.eu)               *
* Date:         2024-10-09 19:04                                                   *
* Version:      1.0                                                                *
...
namespace Alison.Library.Encoders.DoubleMetaphoneInternal
{
    public class DoubleMetaphoneInternal 
    {
...
*/
		...
		/// </param>
		public DoubleMetaphoneInternal(int maxLength) 
        {
        ...
        /// maximal length 4.
        /// </summary>
        public DoubleMetaphoneInternal() : this(4)
        {
        }
        #endregion
        ...
        public string PrimaryCode
        {
            get
            {
                return this._primaryBuffer.ToString();
            }
        }
        ...
        public string SecondaryCode
        {
            get
            {
                return this._secondaryBuffer.ToString();
            }
        }
        #endregion
        ...
        {
            return "DoubleMetaphone_" + _maxLength;
        }
        ...
        {
            this._primaryBuffer.Append(main);
            this._secondaryBuffer.Append(main);
        }
        ...
        private void Add(string main, string alternate)
        {
            ...
            if (alternate.Length > 0)
            {
                ...
                if (!alternate.Equals(" "))
                {
                    this._secondaryBuffer.Append(alternate);
                }
            }
            else
            {
        ...
        public string[] BuildKeys(string word)
        {
            lock (this)
            {
                ...
                while (n < length && (_maxLength < 0 || (_primaryBuffer.Length < _maxLength && _secondaryBuffer.Length < _maxLength)))
                {
                    switch (word[n])
                    {
                ...
                if (this._maxLength < 0)
                {
                    ...
                    {
                        return new[] { this._primaryBuffer.ToString(), this._secondaryBuffer.ToString() };
                    }
                        
                    return new[] { this._primaryBuffer.ToString() };
                }

                // limit the length of the resulting strings
                int primaryLength = Math.Min(_maxLength, _primaryBuffer.Length);

                if (_hasAlternate)
                {
                    int secondaryLength = Math.Min(this._maxLength, this._secondaryBuffer.Length);
                    return new[] { this._primaryBuffer.ToString().Substring(0, (primaryLength) - (0)), this._secondaryBuffer.ToString().Substring(0, (secondaryLength) - (0)) };
                }

                return new[] { this._primaryBuffer.ToString().Substring(0, (primaryLength) - (0)) };
            }
        }
    }
}